  ...
  return (
    <section className="popup-container">
      ...
      <div className="personal-information">
        ...
        <div className="flex flex-col w-3/5 h-full mt-2 px-5 text-lg">
          <p>
            <TypeAnimation
          ...
          <div className="flex flex-1 items-center justify-end h-full">
            <a rel="noreferrer" href="http://algonquincollege.com" target="_blank">
              <img src="./src/assets/algonquin_college.png" className="h-1/3 px-2 rounded-xl" />
            </a>
          </div>
        </div>
      </div>
