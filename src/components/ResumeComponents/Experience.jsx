    ...
    <section className="experience-section">
      ...
      <div className="experience-item">
        <div className="flex flex-col w-1/2 bg-slate-200 rounded-l-xl">
          ...
          <Scrollbars autoHide>
          <ul className="pl-6 list-disc text-lg pr-2">
        ...
        <div className="flex justify-center items-center w-1/2 bg-green-300 rounded-r-xl">
          <img src={Shopify} className="w-96 h-96 object-contain" />
        </div>
      </div>
      <div className="experience-item">
      ...
      <div className="experience-item">
        ...
        <div className="flex justify-center items-center w-1/2 bg-red-300 rounded-r-xl">
          <img src={McDonalds} className="w-96 h-96 object-contain" />
        </div>
      </div>
      </Scrollbars>
    </section>
